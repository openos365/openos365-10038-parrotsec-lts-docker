# openos365-10038-parrotsec-lts-docker
...
docker run -it openos365/openos365-10038-parrotsec-lts-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10038-parrotsec-lts-docker-main-www:latest
docker run -it openos365/openos365-10038-parrotsec-lts-docker-main-www:latest bash
```
